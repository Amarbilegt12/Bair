...
for i in range(1, 6):
    url = f'https://www.unegui.mn/l-hdlh/l-hdlh-zarna/oron-suuts-zarna/{str(i)}-r/ulan-bator/'
    ...
    for x in range(2, page_number_list+1):
        page_url = f'https://www.unegui.mn/l-hdlh/l-hdlh-zarna/oron-suuts-zarna/ulan-bator/?page={x}'
...
with codecs.open('UNEGUI.csv', 'w', 'utf-8-sig') as f:
